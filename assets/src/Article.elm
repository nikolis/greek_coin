...
fetch : Maybe Cred -> Slug -> Http.Legacy.Request (Article Full)
...
favorite : Slug -> Cred -> Http.Legacy.Request (Article Preview)
favorite articleSlug cred =
    Api.post (Endpoint.favorite articleSlug) (Just cred) Http.emptyBody (faveDecoder cred)


unfavorite : Slug -> Cred -> Http.Legacy.Request (Article Preview)
